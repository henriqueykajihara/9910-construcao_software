  ...
  return (
    <IonContent fullscreen={true} color="light">
      <div className="quantidade-tickets">
        ...
        <IonButton fill="clear" color="light" className="ion-no-padding">
          Sair
        </IonButton>
      </div>

      <h3 className="ion-padding-start ion-text-center ion-no-margin ion-margin-top">
        Utilizar seus tickets
      </h3>
